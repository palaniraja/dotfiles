...
;; My own customizations here

;; Nicer rounded/curved seperated in status bar
(setq ns-use-srgb-colorspace nil)

;; unix/utf seperator in statusbar next to line numbers
(setq powerline-default-separator 'utf-8)

;; enable inline images globally, seems to work default without the line below
;; (setq org-startup-with-inline-images t)

;; Global line numbers in left margin/gutter
(global-linum-mode t)
...
;; Trello - https://org-trello.github.io/install.html
;; Note: use username, not the email id.
;; (require 'org-trello)

(setq dotspacemacs-additional-packages '(org-trello))

;; (require 'org-trello)
;; (custom-set-variables '(org-trello-files '("/path/to/file0" "/path/to/file1")))

;; (setq org-trello-consumer-key "KEY_HERE"
;;     org-trello-access-token "TOKEN_HERE")
